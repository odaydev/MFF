...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 02 Décembre 2015 à 15:29
...
CREATE TABLE `post` (
  ...
  `creator_id` int(10) UNSIGNED NOT NULL,
  `destiantaire_id` int(10) UNSIGNED NOT NULL,
  `created` datetime NOT NULL,
...
INSERT INTO `users` (`id`, `login`, `id_amis`, `email`, `messages`, `id_mur`, `password`, `inscription`, `photo`, `birthday`, `last_connexion`) VALUES
(2, 'dsdsf', 3, 'fdsdfs@ghf.fr', 'grrtgrtrtrttrg', 1, '', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00 00:00:00'),
(3, 'htyty', 2, 'gfgf@gfgf.fr', 'cfdrfde', 2, '', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00 00:00:00'),
(4, 'dfdfreruhj', 4, 'gfgf@ngh.fr', 'ghtgfgf', 1, '', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00 00:00:00');
...
ALTER TABLE `post`
  ...
  ADD KEY `dest_id` (`destiantaire_id`),
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `amis` (`id_amis`),
  ADD KEY `id_mur` (`id_mur`),
...
ALTER TABLE `post`
  ...
  ADD CONSTRAINT `users_destinataire_post` FOREIGN KEY (`destiantaire_id`) REFERENCES `users` (`id`);
