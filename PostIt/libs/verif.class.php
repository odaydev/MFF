			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						$lien = '<a href="http://localhost/formation/MFF v7-12/libs/verif-token.php?to='.$token.'&i='.$id.'">http://www.mff.com/verif/u675CXIV9YOLHbYIjhgc8O7UNM</a>';
						$lien_img = "https://d13yacurqjgara.cloudfront.net/users/5591/screenshots/109839/shot_1296759907.jpg";
